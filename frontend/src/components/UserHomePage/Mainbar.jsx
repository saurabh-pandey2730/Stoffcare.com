...
import {useModelState,useMediaQuery} from '../Home/Custom_hooks/custom'
...
if(matched===true)
  ...
  <div className='company_logo' style={{display:'flex',position:'absolute',marginLeft:'20%'}}>
    ...
    <div className='navbar' style={{position:'fixed'}}>
       ...
       : 
       <div className='links' style={{marginLeft:'55%'}}>
      ...
      <Link to={`/myProfile/${userId}`} style={{textDecoration:'none',color:'white'}}>PROFILE</Link>
      </button>
